...
import org.blackdog.type.AlawSongItem;
...
/**
 *
 * Define a song item factory for alaw files
 *
 * @author alexis
 */
public class AlawSongItemFactory extends AbstractSongItemFactory
{
    /** logger */
    private transient Logger logger = Logger.getLogger( AlawSongItemFactory.class );

    /** Creates a new instance of AlawSongItemFactory */
    public AlawSongItemFactory(  )
    {	}
