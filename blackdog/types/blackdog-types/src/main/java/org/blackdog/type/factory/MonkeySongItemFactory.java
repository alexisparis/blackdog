...
import org.blackdog.type.MonkeySongItem;
...
/**
 *
 * Define a song item factory for monkey files
 *
 * @author alexis
 */
public class MonkeySongItemFactory extends DefaultTaggedSongItemFactory
{
    /** logger */
    private transient Logger logger = Logger.getLogger( MonkeySongItemFactory.class );

    /** Creates a new instance of MonkeySongItemFactory */
    public MonkeySongItemFactory(  )
    {	}
