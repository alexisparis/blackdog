 ...
 * @author alexis
 */
public class DefaultTaggedSongItemFactory extends DefaultSongItemFactory
{
    /** Creates a new instance of DefaultTaggedSongItemFactory */
    public DefaultTaggedSongItemFactory(  )
    {
    }
    ...
    {
        super.completeInformation( item, report );

        if ( item instanceof TaggedSongItem )
        {
//	    ((TaggedSongItem)item).updateItemsTags(report);
        }
    }
}
