...
import java.net.URL;
import org.blackdog.type.WavSongItem;

/**
 *
 * Define a song item factory for wav files
 *
 * @author alexis
 */
public class WavSongItemFactory extends DefaultTaggedSongItemFactory
{
    /** logger */
    private transient Logger logger = Logger.getLogger( WavSongItemFactory.class );

    /** Creates a new instance of WavSongItemFactory */
    public WavSongItemFactory(  )
    {	}
