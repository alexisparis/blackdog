...
import org.blackdog.type.PcmSongItem;
...
/**
 *
 * Define a song item factory for pcm files
 *
 * @author alexis
 */
public class PcmSongItemFactory extends AbstractSongItemFactory
{
    /** logger */
    private transient Logger logger = Logger.getLogger( PcmSongItemFactory.class );

    /** Creates a new instance of PcmSongItemFactory */
    public PcmSongItemFactory(  )
    {	}
