 ...
 */
@Bean( 
        name = "ScannedDirectory", internationalizationRef = "org.blackdog.rc.i18n.type.ScannedDirectory", expert = false, hidden = false, preferred = true, propertiesClassLimit = Object.class, methodsClassLimit = Object.class
     )
public class ScannedDirectory
    extends SibDirectory
{
    /** Creates a new instance of ScannedDirectory */
    public ScannedDirectory(  )
    {
    }
