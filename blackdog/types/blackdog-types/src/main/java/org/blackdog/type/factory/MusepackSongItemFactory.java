...
import org.blackdog.type.MpcSongItem;
...
/**
 *
 * Define a song item factory for mpc files
 *
 * @author alexis
 */
public class MusepackSongItemFactory extends DefaultTaggedSongItemFactory
{
    /** logger */
    private transient Logger logger = Logger.getLogger( MusepackSongItemFactory.class );

    /** Creates a new instance of MusepackSongItemFactory */
    public MusepackSongItemFactory(  )
    {	}
