...
/**
 *
 * indicate to refresh Player used by Musik kernel resources
 *
 * @author alexis
 */
public class ChangePlayerAction implements ValidateAction
{
    ...
    {
	/* force kernel resources to refresh player to use */
