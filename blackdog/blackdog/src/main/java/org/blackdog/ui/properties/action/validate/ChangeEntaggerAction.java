...
/**
 *
 * indicate to refresh AudioEntagger used by Musik kernel resources
 *
 * @author alexis
 */
public class ChangeEntaggerAction implements ValidateAction
{
    ...
    {
	/* force kernel resources to refresh entagger to use */
	MusikKernelResources.getInstance().resetAudioEntagger();
    }
