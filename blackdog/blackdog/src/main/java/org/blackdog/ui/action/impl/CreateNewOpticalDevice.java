...
import org.blackdog.type.device.OpticalDevice;
import org.siberia.type.SibList;
import org.siberia.ui.action.impl.AddingTypeAction;

/**
 *
 * Allow to create a new Optical device
 *
 * @author alexis
 */
public class CreateNewOpticalDevice extends AddingTypeAction<SibList>
{
    
    /** Creates a new instance of CreateNewOpticalDevice */
    public CreateNewOpticalDevice()
    {   super();
