...
/**
 *
 * Allow to create a new PlayList
 *
 * @author alexis
 */
public class CreateNewPlayList extends AddingTypeAction<SibList>
{
    
    /** Creates a new instance of CreateNewPlayList */
    public CreateNewPlayList()
    {   super();
        
        this.setTypes(MusikKernelResources.getInstance().getAudioResources().getPlayListList());
    }
