...
import org.blackdog.type.device.IPodDevice;
import org.siberia.type.SibList;
import org.siberia.ui.action.impl.AddingTypeAction;

/**
 *
 * Allow to create a new IPod device
 *
 * @author alexis
 */
public class CreateNewIPodDevice extends AddingTypeAction<SibList>
{
    
    /** Creates a new instance of CreateNewIPodDevice */
    public CreateNewIPodDevice()
    {   super();
