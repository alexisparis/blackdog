 ...
 * @author alexis
 */
public class CopySongsToAction<E extends SongItem> extends CopyOrMoveSongsToAction<E>
{
    /**
     * Creates a new instance of CopySongsToAction
     */
    public CopySongsToAction()
    {   super(); }
