...
public interface ITechnicalStrings {
  ...
  // Jajuk version
  String JAJUK_VERSION_TEST = "1.5b3";

  String JAJUK_VERSION = JAJUK_VERSION_TEST;

  String JAJUK_CODENAME = "Lothlórien";

  String JAJUK_VERSION_DATE = "Build: 2008/02/03 22:58";
  ...
  // Playlists
  String PLAYLIST_NOTE = "#Playlist generated by Jajuk " + JAJUK_VERSION;
  ...
  String[] XML_RESERVED_ATTRIBUTE_NAMES = { XML_NAME, XML_ID, XML_TYPE_EXTENSION,
      ...
      XML_TRACK_ADDED, XML_DIRECTORY_PARENT, XML_DEVICE, XML_DIRECTORY, XML_TRACK, XML_SIZE,
      XML_QUALITY, XML_HASHCODE, XML_PLAYLIST_FILES, XML_TRACK_COMMENT, XML_ANY, XML_TRACK_ORDER,
