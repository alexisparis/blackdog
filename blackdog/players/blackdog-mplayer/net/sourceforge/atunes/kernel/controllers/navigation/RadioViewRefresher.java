...
public class RadioViewRefresher {
	...
	private static void addRadioNodes(List<Radio> radios, DefaultMutableTreeNode root, String currentFilter) {
		if (radios == null)
			return;
	...
	public static void refresh(List<Radio> radios, DefaultTreeModel treeModel, String currentFilter) {
		DefaultMutableTreeNode root = (DefaultMutableTreeNode) treeModel.getRoot();
		root.setUserObject(LanguageTool.getString("RADIO"));
		root.removeAllChildren();
		addRadioNodes(radios, root, currentFilter);
		treeModel.reload();
	}
}
