...
public class ClearTagsProcess implements Runnable {

	private Logger logger = new Logger();

	private List<AudioFile> filesToClear;
	...
	public void run() {
		...
		for (AudioFile file : filesToClear) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			@Override
			public void run() {
				TagModifier.refreshAfterTagModify(filesToClear);
			}
		});
