 ...
 * following url:
 * 
 * http://ecs.amazonaws.com/onca/xml?Service=AWSECommerceService&Operation=ItemSearch&SubscriptionId=06SX9FYP905XDBHBCZR2&SearchIndex=Music&Artist=Metallica&Title=Load&ResponseGroup=Images,Tracks
 */
public class AmazonAlbum {
	...
	protected static AmazonAlbum getAlbum(Document xml) {
		...
		if (tracks == null) // No tracks -> Abort
			return album;
