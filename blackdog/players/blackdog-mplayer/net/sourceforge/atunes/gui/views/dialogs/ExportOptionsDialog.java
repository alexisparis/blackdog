...
public class ExportOptionsDialog extends CustomModalDialog {
	...
	private JPanel getContent() {
		...
		exportLocation = new CustomJFileChooser(this, 30, JFileChooser.DIRECTORIES_ONLY);
		...
		fullStructureRadioButton = new JRadioButton(StringUtils.getString(LanguageTool.getString("ARTIST"), " / ", LanguageTool.getString("ALBUM")));
		...
		customFileNamesRadioButton = new JRadioButton(StringUtils.getString(LanguageTool.getString("CUSTOM"), "..."));
		customFileNameFormatTextField = new JTextField(10);
		formatInfoLabel = new JLabel(StringUtils.getString("%T= ", LanguageTool.getString("TITLE"), "           %A= ", LanguageTool.getString("ARTIST") + "            %L= "
				+ LanguageTool.getString("ALBUM")));
