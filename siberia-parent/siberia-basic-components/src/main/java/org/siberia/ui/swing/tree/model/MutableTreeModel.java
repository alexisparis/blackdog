...
/**
 *
 * Default implementation of a GenericTreeModel that allow the model to be modified
 *
 * @author alexis
 */
public class MutableTreeModel extends GenericTreeModel
{
    
    /** Creates a new instance of MutableTreeModel */
    public MutableTreeModel()
    {   this(null); }
    
    /** create a new MutableTreeModel
     *  @param root an instance of SibType
     */
    public MutableTreeModel(SibType root)
    {   super(root); }
