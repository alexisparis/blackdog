...
public class CloseTabPaneEclipseUI extends CloseableTabbedPaneUI {
	...
	protected void paintTabBackground(
		...
		if (isSelected) {
			...
			if (tabPane.isEnabledAt(tabIndex)) {
				...
				leftGradient =
					new GradientPaint(x, y, shadow, x + w / 2, y, lightWhite);
	...
	protected class ScrollableTabButton
		extends CloseableTabbedPaneUI.ScrollableTabButton {
	...
	protected CloseableTabbedPaneUI.ScrollableTabButton createScrollableTabButton(
		int direction) {
