...
/**
 *
 * Default table model adapter factory
 *
 * @author alexis
 */
public class DefaultAdapterFactory<M extends TreeTableModel> implements AdapterFactory<M>
{
    
    /** Creates a new instance of DefaultAdapterFactory */
     ...
     *	@return a TableModel
     */
    public TableModel createModelAdapter(M treeTableModel, JTree tree)
    {
