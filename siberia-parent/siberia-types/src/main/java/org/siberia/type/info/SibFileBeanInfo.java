...
import org.siberia.type.SibFile;
import org.siberia.type.SibURL;

/**
 *
 * BeanInfo for SibFile
 *
 * @author alexis
 */
public class SibFileBeanInfo extends BaseTypeBeanInfo
{
    /** Creates a new instance of SibFileBeanInfo */
    public SibFileBeanInfo()
    {   super(SibFile.class, DefaultFile.class); }
	...
	if ( SibFile.PROPERTY_VALUE.equals(descriptor.getName()) )
	{   
	    ResourceBundle rb = ResourceBundle.getBundle(SibFileBeanInfo.class.getName());
	    
	    descriptor.setDisplayName(rb.getString("file.displayName"));
	    descriptor.setShortDescription(rb.getString("file.description"));
