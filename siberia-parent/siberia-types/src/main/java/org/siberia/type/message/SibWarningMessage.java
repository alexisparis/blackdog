 ...
 * @author alexis
 */
@Bean(  name="SibWarningMessage",
        internationalizationRef="org.siberia.rc.i18n.type.SibWarningMessage",
        expert=true,
        hidden=true,
        preferred=true,
...
public class SibWarningMessage extends SibMessage
{
    /**
     * Creates a new instance of SibErrorMessage
     */
    public SibWarningMessage()
    {	
	this.setMessageLevel(Level.WARNING);
    }
