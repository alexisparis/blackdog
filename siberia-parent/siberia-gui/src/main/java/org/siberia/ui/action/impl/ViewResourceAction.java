 ...
 * @author alexis
 */
public abstract class ViewResourceAction extends TypeEditingAction<ColdResource>
{
    
    /** Creates a new instance of ViewResourceAction
     *  @param resourceCode the code associated with the resource
     */
    public ViewResourceAction(String resourceCode)
    {   super();
        
	ColdResource resource = Kernel.getInstance().getResources().getResource(resourceCode);
        this.setTypes(resource);
    }
