 ...
 */
package org.siberia.ui.properties.action.apply;
...
/**
 *
 * Set the look and feel according to preferences
 *
 * @author alexis
 */
public class ApplyLookAndFeelAction implements ApplyAction
{

    public void applyChange(String propName, XmlProperty property)
    {   if ( propName.equals(XmlProperty.PROP_VALUE) )
        {   /* specify the look and fell */
            UserInterface.getInstance().applyLookAndFeelByName(property.getCurrentValue());
        }
    }
