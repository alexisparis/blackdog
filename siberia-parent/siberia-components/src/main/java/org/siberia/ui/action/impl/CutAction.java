 ...
 * @author alexis
 */
public class CutAction extends TypeReferenceAction<SibType>
{
    /** logger */
    private Logger logger = Logger.getLogger(CutAction.class);
    
    /** Creates a new instance of CopyAction
     *  @param instance an instance related to this action
     */
    public CutAction(Object instance)
    {   super("Cut");
	
	String iconPath = SiberiaComponentsPlugin.PLUGIN_ID + ";1::img/Cut.png";
        try
