...
/**
 *
 * Exception throwed when a plugin could not be fund
 *
 * @author alexis
 */
public class ResourceNotFoundException extends DownloadException
{   
    /** Creates a new instance of SiberiaPluginNotFundException
