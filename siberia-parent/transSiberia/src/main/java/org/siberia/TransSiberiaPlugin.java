 ...
 * @author alexis
 */
public class TransSiberiaPlugin
{
    /** id of the plugin */
    public static final String PLUGIN_ID = "transSiberia";
    
    /** path to the resources directory */
    public static final String RC_PATH   = "org/siberia/rc";
    
    /** Creates a new instance of TransSiberiaPlugin */
    protected TransSiberiaPlugin()
    {   }
