...
{   
	...
	for(int i = 0; i < ((Module)o).getBuild().size(); i++)
	{
	    ...
	    System.out.println("build date : " + build.getReleaseDate());
	    Calendar cal = build.getReleaseDate().toGregorianCalendar();
...
//	module.getLocation().setValue("location");
//	module.getDeclarationFileName().setValue("filename");
	...
	XMLGregorianCalendar calendar = 
		javax.xml.datatype.DatatypeFactory.newInstance().newXMLGregorianCalendar(cal);
...
//    <build version="0.0.1" releaseDate="2002-09-24" license="GPL" active="false" check="md5">
//    </build>
//    
//    <build version="0.0.2" releaseDate="2003-01-13" license="LGPL" check="sha1">
//        <dependency name="siberia-lang" minVersion="0.0.2"/>
//    </build>
    }
}
