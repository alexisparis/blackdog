...
import org.blackdog.type.FlacSongItem;
import org.blackdog.type.SongItem;
import org.blackdog.type.VorbisSongItem;

import java.net.URL;

/**
 *
 * Define a song item factory for flac files
 *
 * @author alexis
 */
public class FlacSongItemFactory extends DefaultTaggedSongItemFactory
{
    /** logger */
    private transient Logger logger = Logger.getLogger( FlacSongItemFactory.class );

    /** Creates a new instance of FlacSongItemFactory */
    public FlacSongItemFactory(  )
    {
    }
