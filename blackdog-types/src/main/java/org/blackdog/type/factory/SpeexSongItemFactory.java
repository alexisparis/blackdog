...
/**
 *
 * Define a song item factory for speex files
 *
 * @author alexis
 */
public class SpeexSongItemFactory extends DefaultTaggedSongItemFactory
{
    /** logger */
    private transient Logger logger = Logger.getLogger( SpeexSongItemFactory.class );

    /** Creates a new instance of VorbisSongItemFactory */
    public SpeexSongItemFactory(  )
    {	}
