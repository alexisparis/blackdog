...
/**
 *
 * Define a song item factory for ogg files
 *
 * @author alexis
 */
public class VorbisSongItemFactory extends DefaultTaggedSongItemFactory
{
    /** logger */
    private transient Logger logger = Logger.getLogger( VorbisSongItemFactory.class );

    /** Creates a new instance of VorbisSongItemFactory */
    public VorbisSongItemFactory(  )
    {
    }
