...
import org.blackdog.type.GsmSongItem;
...
/**
 *
 * Define a song item factory for gsm files
 *
 * @author alexis
 */
public class GsmSongItemFactory extends AbstractSongItemFactory
{
    /** logger */
    private transient Logger logger = Logger.getLogger( GsmSongItemFactory.class );

    /** Creates a new instance of GsmSongItemFactory */
    public GsmSongItemFactory(  )
    {	}
