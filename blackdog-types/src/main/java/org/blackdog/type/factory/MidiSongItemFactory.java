...
import java.net.URL;
import org.blackdog.type.MidiSongItem;

/**
 *
 * Define a song item factory for midi files
 *
 * @author alexis
 */
public class MidiSongItemFactory extends AbstractSongItemFactory
{
    /** logger */
    private transient Logger logger = Logger.getLogger( MidiSongItemFactory.class );

    /** Creates a new instance of MidiSongItemFactory */
    public MidiSongItemFactory(  )
    {	}
