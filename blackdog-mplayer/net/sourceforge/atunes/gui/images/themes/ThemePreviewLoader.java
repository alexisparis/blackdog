...
public class ThemePreviewLoader {
	...
	private static Map<String, String> previews = new HashMap<String, String>();
	...
	static {
		...
		previews.put("Default", "DefaultPreview.PNG");
		...
		previews.put("Sunset", "SunsetPreview.PNG");
		previews.put("Terracotta", "TerracottaPreview.PNG");
