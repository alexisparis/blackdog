...
public class JSPlayer extends AbstractPlayer implements Runnable
{
   ...
   */
  public JSPlayer(JSPlayerListener bpl)
  {
    this();
    m_bpl = bpl;
  }
    ...
    public void playAtImpl(double d)
    {
        // TODO
    }
    ...
    public void setItem(Playable item)
    {
        ...
        try
        {   this.setDataSource(item == null ? null : item.createInputStream());
        }
  ...
  { if (m_dataSource instanceof InputStream)
    {
  ...
  protected void initLine() throws LineUnavailableException
  {
    if (m_line == null)
    {
        System.err.println("before creating line");
      createLine();
      trace(1, getClass().getName(), "Create Line OK ");
        System.err.println("before opening line");
      openLine();
    }
    else
    {
      ...
      {
        System.err.println("before closing line");
        System.err.println("available 1 : " + m_line.available());
        
        
        System.err.println("line running ? " + m_line.isRunning());
        System.err.println("line active ? " + m_line.isActive());
        
//        if ( m_line.isRunning() )
        {   
            
            m_line.flush();
            System.err.println("available 2 : " + m_line.available());
//            m_line.drain();
            System.err.println("available 3 : " + m_line.available());
            m_line.stop();
            System.err.println("available 4 : " + m_line.available());
            m_line.close();
            System.err.println("available 5 : " + m_line.available());
        }
        System.err.println("available 6 : " + m_line.available());
        System.err.println("before opening line");
        openLine();
      }
    }
...
//      m_audioInputStream = AudioSystem.getAudioInputStream(targetFormat, m_audioInputStream);
  ...
  private void openLine() throws LineUnavailableException
  {
    if (m_line != null)
    {
      ...
      System.out.println("line to be open");
  ...
  {
    System.err.println("nombre de threads actifs = " + Thread.activeCount());
    ...
    if ( (m_status == STOPPED) || (m_status == READY))
    {
      ...
      if (! (m_thread == null || !m_thread.isAlive()))
      {
        ...
        {
            System.err.println("m_status : " + m_status);
          try
          {
            if (m_thread != null)
            {
      ...
      try
      {
          System.err.println("before calling initLine");
        initLine();
      }
      catch (Exception e)
      {
...
//          System.out.println("secondsTotal : " + secondsTotal);
//          System.out.println("nbmilliseconds : " + nbmilliseconds);
          System.err.println("length total in seconds : " + this.getTotalLengthInSeconds());

          nBytesCursor = nBytesCursor + nBytesWritten;
          if (m_bpl != null)
          {
              int a = (int) Math.round( (float) nBytesCursor / bytesPerSecond);
            m_bpl.updateCursor(a , secondsTotal);
    ...
    if (m_line != null)
    {
      try
      {
        ...
        this.fireSongItemFullyRead(this.getItem());
      }
      catch (Exception e)
      {
...
//    System.out.println("bitRate : " + bitRate);
  ...
  {
      System.err.println("msg1 : " + msg1 + ", msg2 : " + msg2);
...
//    dbg.log(level, msg1 + ":" + msg2);
  ...
  private void trace(int level, String msg1, String msg2, String msg3)
  {
      ...
      System.err.println("msg1 : " + msg1 + ", msg2 : " + msg2 + ", msg3 : " + msg3);
//    Debug dbg = Debug.getInstance();
