package org.blackdog.player.impl.attic;
...
import org.blackdog.player.impl.*;
 ...
 *
 */
public class SpiPlayerOrigin implements Runnable
{
   ...
   */
  public SpiPlayerOrigin(JSPlayerListener bpl)
  {
    this();
    m_bpl = bpl;
  }
...
//    dbg.log(level, msg1 + ":" + msg2);
  ...
  private void trace(int level, String msg1, String msg2, String msg3)
  {
      ...
      System.out.println("msg1 : " + msg1 + ", msg2 : " + msg2 + ", msg3 : " + msg3);
//    Debug dbg = Debug.getInstance();
